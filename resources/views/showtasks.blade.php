...
<body class="font-sans bg-indigo-700 text-white">
    <div class="container mx-auto p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-md overflow-hidden shadow-lg border-t-4 border-indigo-700 flex flex-col h-full">
